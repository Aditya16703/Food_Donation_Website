...
const About = () => {
  return (
    <div className="px-6 sm:px-12 lg:px-44 py-10  text-gray-900   dark:text-white-900">
      <h1 className="text-3xl sm:text-4xl font-bold text-center underline mb-6  dark:text-white-900">
        About Annadata
      </h1>

      <p className="text-lg sm:text-xl text-justify mb-6  dark:text-white-900 ">
      ...
      <p className="text-lg sm:text-xl text-justify dark:text-white-900">
